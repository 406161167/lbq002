...
float fTranslate;
float fRotate;
float fScale = 1.0f;	// set inital scale value to 1.0fe
...
void Draw_Scene()
{
	...
	glRotatef(r, 0, 0, 1); //notice the rotation here, you may have a TRY removing this line to see what it looks like.
	glRotatef(90, 1, 0, 0); //茶壶正放
...
void updateView(int width, int height)
{
	...
	if (bPersp) {
		gluPerspective(45, 1 * wWidth / wHeight, 1, 100);
